...
$sellers = $conn->query("
    ...
    LEFT JOIN tblaorder o ON o.status = 'paid'
    WHERE u.role = 'seller' AND u.verified = 1
    GROUP BY u.user_id
    ORDER BY total_sales DESC
");
$sellers_count = $sellers->num_rows;
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <title>Pastimes — Admin Sellers</title>
  ...
  <div class="layout-admin">
    ...
    <aside class="sidebar">
      ...
      <nav class="sidebar-nav">
        ...
        <a class="nav-item active" href="admin-sellers.php">
    ...
    <main class="main-content">
      <div class="topbar">
        ...
        <div class="topbar-title">Sellers Management</div>
      ...
      <div class="page-body">
        ...
        <div class="card">
          ...
          <table class="data-table">
            ...
            <tbody>
              <?php if ($sellers_count == 0): ?>
                <tr><td colspan="7" class="text-center">No sellers found.</td></tr>
              <?php else: ?>
                <?php while ($seller = $sellers->fetch_assoc()): ?>
                  <tr>
                    <td><?= htmlspecialchars($seller['name']) ?></td>
                    <td><?= htmlspecialchars($seller['email']) ?></td>
                    <td><?= htmlspecialchars($seller['city'] ?: 'N/A') ?></td>
